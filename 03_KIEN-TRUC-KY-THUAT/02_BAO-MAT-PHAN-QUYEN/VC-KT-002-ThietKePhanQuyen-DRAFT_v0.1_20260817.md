...
Đã vá B1-B4, B7, B11-B19. B11 (đổi tên role) áp dụng trên toàn hệ thống trong
...
mỗi lần vá. B5, B6, B9, B10 và phần `Supply` của B8 còn treo — cần quyết định
nghiệp vụ, không phải lỗ hổng bảo mật hay việc kỹ thuật đơn thuần.
